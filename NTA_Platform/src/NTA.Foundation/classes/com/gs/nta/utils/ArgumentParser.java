...
/**
 * {@code ArgumentParser} is a library for parsing command line arguments in an
 ...
 * {@code -d} or `--debug`. Your program would then simply check if that
...
public class ArgumentParser {
    ...
    {
        args = null;
        switchIndices = new HashMap<String, Integer>();
        takenIndices = new TreeSet<Integer>();
    ...
    /**
     * Creates an instance of the {@code ArgumentParser} class to parse command
     ...
     * @return              {@code true} if the switch is present; `falcse`
     *                      otherwise.
     */
     ...
     *
     * @param <T> the object type desired
