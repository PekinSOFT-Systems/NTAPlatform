...
public class MessageBox {
     ...
     * <p>
     * Error messages should be displayed from any {@code catch()} block where
     * the {@code try} block has failed. Some critical errors should be followed
     * by a call to the {@code exit()} method and the program should be
     ...
     * @param title The title of the message box
     * @param appName The name of the application showing this {@code MessageBox}
     */
    public static void showError(Exception ex, String title, String appName) {
        String msg = "The following exception was thrown by the program:\n\n";
        msg += ex.getMessage() + "\n\nException: ";
        msg += ex.getClass().getSimpleName();
        msg += "\n\nSee also the application logs: "
                + FileUtils.getApplicationLogDirectory(appName);
